...
fle <- "https://raw.githubusercontent.com/sinharitesh/DevelopingDataProducts/master/data/sentiment.csv"
download.file(fle, destfile="temp.csv")
df.sentiment <- read.csv("temp.csv")

```
1. This app uses `r nrow(df.sentiment)` rows of Data from Twitter for analysis.
2. It has got `r length(unique(df.sentiment$EntityName))` leaders.
